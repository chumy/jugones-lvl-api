...
class PartidaParticipanteFecha extends Mailable
{
    ...
    public function __construct($part, $participante, $fecha)
    {
        ...
        $this->data = DataPartida::select('data')->where('dataId', $fecha)->get()[0];
    ...
    {
        return new Envelope(
            subject: 'Molins De Joc: Data proposta  acceptada a '.$this->partida->joc['name'],
        );
    }
