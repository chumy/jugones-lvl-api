		          ...
		          <tr>
		            <td class="bg_light email-section">
		            	<div class="heading-section" style="text-align: center; padding: 0 30px;">
		              	...
		              	<p>S'ha creat una nova partida a {{$partida->joc['name']}}. Si vols inscirue't accedeix al enllaç al final de la informació. A continuació es mostra la informació de la partida </p>
		            	</div>
                    </td>
                    </tr>
                    <tr>
                                    ...
                                    <td valign="top" width="33%" style="padding-top: 20px;">
                                        ...
                                        <tr>
                                            <td class="text-testimony" style="text-align: center;">
                                                ...
                                                <span class="position">{{$organizador->displayName}}</span>
                                            </td>
                                        </tr>
                                        </table>
                                    </td>
                    ...
                    <tr>
                            ...
                            <td class="text-testimony" style="text-align: center;">
                                @foreach($partida->participants as $par)
                                <h4 class="name">{{$par->participant['displayName']}}</h4>
                                @endforeach
                            </td>
                  ...
                  <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                    <tr>
                      <td style="text-align: center; padding-right: 10px;">
                      	...
                      	<p>Reps aquest missatge perque tens les notificacions actives.</p>
                      </td>
                    </tr>
                  </table>
                </td>
